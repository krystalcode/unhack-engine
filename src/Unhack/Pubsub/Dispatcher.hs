...
-}
dispatch :: USEC.StorageConfig -> USEC.StorageIndexSettings -> BS.ByteString -> IO ()
dispatch config indexSettings message = do
    ...
    case action of
        ...
        "repositories_create" -> do
            ...
            UPR.clone config indexSettings repositoryId
            {-
                @Issue(
